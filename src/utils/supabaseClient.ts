...
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'sb_secret_FNqdX4v85TOTgPc9w9lrBg_XjjOt0ty'; // Using the known service key as fallback so it works instantly
